...
Invoke-WebRequest -Uri "https://github.com/humbertoschoenwald/auto-theme-solar-engine/releases/download/v26.05.01/auto-theme-solar-engine-win-x64-self-contained-v26.05.01.exe" -OutFile ".\auto-theme-solar-engine-win-x64-self-contained-v26.05.01.exe"
Move-Item -LiteralPath ".\auto-theme-solar-engine-win-x64-self-contained-v26.05.01.exe" -Destination ".\AutoThemeSolarEngine.exe" -Force
